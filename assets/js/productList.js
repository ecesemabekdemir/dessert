...
function createProductHtml(image, name,id, category, price) {
 return ` 
  <div  class="dessert">
    <img src="${image}">
    <button data-id="${id}" id="addProduct">Add to Cart</button>
...
// addProductBasket fonksiyonunda çağırmayı unutma.
